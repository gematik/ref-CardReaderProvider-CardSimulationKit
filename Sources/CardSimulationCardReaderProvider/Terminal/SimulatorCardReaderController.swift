...
public class SimulatorCardReaderController: CardReaderControllerType {
    ...
    public var cardReaders: [CardReaderType] {
        return self.simulatorCardReaders.map { $0 }
    }
...
extension SimulatorCardReaderController: SimulationManagerDelegate {
    public func simulation(manager: SimulationManagerType, didStart simulator: SimulationRunnerType) {
    ...
    public func simulation(manager: SimulationManagerType, didEnd simulator: SimulationRunnerType) {
